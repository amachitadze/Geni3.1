...
export interface Statistics {
    ...
    youngestLivingPerson: { name: string; age: number; } | null;
...
const StatisticsModal: React.FC<StatisticsModalProps> = ({ isOpen, onClose, stats, theme, language }) => {
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-4xl border border-gray-300 dark:border-gray-700 max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700">
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">{t.stats_demographics}</h3>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                               <div className="p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex flex-col">
                                   <h4 className="text-sm font-semibold text-center text-gray-700 dark:text-gray-300 mb-2">{t.stats_gender}</h4>
                                   <div className="flex-grow">
                                     <DoughnutChart labels={['Male', 'Female']} data={[stats.genderData.male, stats.genderData.female]} theme={theme} />
                                   </div>
                               </div>
                               <div className="p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex flex-col">
                                   <h4 className="text-sm font-semibold text-center text-gray-700 dark:text-gray-300 mb-2">{t.stats_status}</h4>
                                   <div className="flex-grow">
                                     <DoughnutChart labels={['Living', 'Deceased']} data={[stats.statusData.living, stats.statusData.deceased]} theme={theme} />
                                   </div>
                               </div>
                            </div>
                            <div className="p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex flex-col">
                                <h4 className="text-sm font-semibold text-center text-gray-700 dark:text-gray-300 mb-2">{t.stats_age_groups}</h4>
                                <div className="flex-grow">
                    ...
                    {hasAdditionalStats && (
                        <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700">
                            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">{t.stats_interesting}</h3>
                            <AdditionalStats 
                                oldestPerson={stats.oldestLivingPerson}
                                youngestPerson={stats.youngestLivingPerson}
                    ...
                    {stats.generationData.data.length > 0 && (
                        <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700">
                            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">{t.stats_generations}</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 h-64 flex flex-col">
                                    <h4 className="text-sm font-semibold text-center text-gray-700 dark:text-gray-300 mb-2">{t.stats_people_generations}</h4>
                                    <div className="flex-grow">
                                ...
                                {stats.birthRateData.data.length > 0 && (
                                    <div className="p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 h-64 flex flex-col">
                                        <h4 className="text-sm font-semibold text-center text-gray-700 dark:text-gray-300 mb-2">{t.stats_birth_rate}</h4>
                                        <div className="flex-grow">
                    ...
                    {/* Popular Names Section */}
                     {(stats.topMaleNames.length > 0 || stats.topFemaleNames.length > 0) && (
                        <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700">
                            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">{t.stats_popular_names}</h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <NameList title={t.stats_top_male} names={stats.topMaleNames} />
                                <NameList title={t.stats_top_female} names={stats.topFemaleNames} />
                            </div>
                        </div>
                     )}
                </div>
