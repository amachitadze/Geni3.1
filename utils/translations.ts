...
export const translations = {
    ka: {
        ...
        menu_notifications: "შეტყობინებები", // New
        ...
        btn_view: "ნახვა",
        tab_birthdays: "ამ თვის იუბილარები",
        notification_center: "შეტყობინებების ცენტრი",
        tab_messages: "შეტყობინებები",
        no_messages_list: "შეტყობინებები არ არის.",
        msg_read_more: "სრულად",
    ...
    es: {
        ...
        menu_notifications: "Notificaciones", // New
        ...
        btn_vote: "Votar",
        btn_view: "Ver",
        tab_birthdays: "Cumpleaños del mes",
        notification_center: "Centro de notificaciones",
        tab_messages: "Mensajes",
        no_messages_list: "No hay mensajes.",
        msg_read_more: "Ver más",

        // Password Prompt
        pwd_title: "Descifrar árbol",
        pwd_desc: "Por favor, introduce la contraseña para ver este árbol genealógico.",
        ...
        landing_features_title: "¿Por qué nuestra plataforma es única?",
        landing_features_desc: "Hemos combinado simplicidad y potencia para mantener segura y fácil de gestionar la historia de tu familia.",
        landing_footer_cta_title: "Guarda el pasado para el futuro",
        landing_footer_cta_desc: "La historia de tu familia merece el mejor lugar. Empieza hoy, totalmente gratis.",
        landing_copyright: "Árbol Genealógico. Todos los derechos reservados.",
        landing_created_by: "Creado",
        landing_by: "por",
        ...
        feat_share_title: "Mensajes y Compartir",
        feat_share_desc: "Comparte el árbol con familiares mediante un enlace seguro y envía mensajes a toda la familia.",
        ...
        feat_mobile_desc: "Interfaz totalmente adaptada. Gestiona tu árbol desde cualquier lugar, con cualquier dispositivo.",
        // NEW FEATURES
        feat_timeline_title: "Línea de tiempo",
        feat_timeline_desc: "Viaja en el tiempo. Ve la historia de tus antepasados junto con eventos históricos.",
        feat_map_title: "Mapa geográfico",
        feat_map_desc: "Descubre tus raíces en el mapa. Mira dónde nacieron y vivieron tus antepasados.",

        // Pricing Plans
        pricing_title: "Elige tu plan",
        pricing_subtitle: "Empieza gratis, mejora según necesites.",
        plan_free: "Gratis",
        ...
        feat_messages: "Enviar notificaciones",
        ...
        initial_desc: "Empieza a crear la historia de tu familia. Elige una de las opciones a continuación.",
        initial_btn_create: "Empezar a crear árbol",
        initial_btn_import: "Importar datos",

        // Testimonials
        testim_title: "Lo que dicen los usuarios",
        testim_1_name: "Jorge B.",
        testim_1_role: "Historiador",
        testim_1_text: "Esta plataforma me ayudó a reconstruir 5 generaciones. ¡La interfaz es increíblemente sencilla!",
        testim_2_name: "Nina T.",
        testim_2_role: "Madre",
        testim_2_text: "Un verdadero tesoro para mis hijos. Lo llenamos juntos y nos divertimos.",
        testim_3_name: "David M.",
        ...
        auth_confirm_password: "Repetir contraseña",
        ...
        step_1_desc: "Empieza contigo mismo. Introduce tu nombre y apellido en el sistema.",
        ...
        faq_1_a: "Sí. Los datos se almacenan localmente en tu navegador. Solo se envían al servidor cuando eliges compartirlos o hacer una copia de seguridad.",
        ...
        faq_3_a: "Creas un enlace encriptado y una contraseña. El enlace es de un solo uso y se elimina automáticamente del servidor tras abrirse para mayor seguridad.",
    }
};
